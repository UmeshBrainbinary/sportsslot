      ...
      child: Scaffold(
          ...
          body: SafeArea(
            child: Column(children: [
              ...
              Expanded(
                child: controller.nearlyYoudata.isNotEmpty
                    ? ListView.builder(
                        primary: false,
                        shrinkWrap: true,
                        ...
                        itemBuilder: (context, index) {
                          return FutureBuilder(
                              future: homeController.getLocationName(
                                  controller.nearlyYoudata[index].latitude
                                      .toDouble(),
                                  controller.nearlyYoudata[index].longitude
                                      .toDouble()),
                    ...
                    : Center(
                        child: Text("no_data".tr,
                            style: theme.textTheme.displayMedium!.copyWith(
                                color: appTheme.buttonColor, fontSize: 14)),
                      ),
              )
            ]),
          )),
