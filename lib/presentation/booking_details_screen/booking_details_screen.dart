...
class _BookingDetailsScreenState extends State<BookingDetailsScreen> {
  ...
  void initState() {
     ...
     controller.data = Get.arguments["data"];
  ...
  Widget buildDetails() {
    return Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          SizedBox(height: 20.v),
          _buildDate(date: "lbl_booking_code".tr, friSep: data.bookingCode??""),
          SizedBox(height: 18.v),
          _buildDate(date: "lbl_date".tr, friSep: data.date??""),
          SizedBox(height: 18.v),
          _buildDate(date: "lbl_time".tr, friSep: data.time??"")
        ]));
  }
