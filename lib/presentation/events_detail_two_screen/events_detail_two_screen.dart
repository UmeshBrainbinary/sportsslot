...
class _EventsDetailTwoScreenState extends State<EventsDetailTwoScreen> {
            ...
            children: [
              ...
              Padding(
                ...
                child: CustomImageView(
                  imagePath: eventsItemModel.image?[0], //ImageConstant.imgIamge,
                  height: 180.v,
              ...
              _buildTitle(
                groundName: eventsItemModel.tournamentName ?? "",
                location: "msg_agrasen_institute".tr,
                ticketPrice: eventsItemModel.entryFee ?? "",
              ),
  ...
  /// Section Widget
  Widget _buildTitle({groundName, location, ticketPrice}) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 20.h),
      child:  Padding(
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                Expanded(child: Text(groundName /*"msg_football_tournament2".tr*/, style: CustomTextStyles.titleLarge22)),
                Text(ticketPrice,/*"lbl_100_00".tr,*/ style: CustomTextStyles.titleLargePrimary),
              ],
            ),
            Row(
              children: [
                ...
                Padding(
                  ...
                  child: Text(location/*"msg_agrasen_institute".tr*/, style: theme.textTheme.bodyMedium!.copyWith(color: appTheme.black900)),
                ),
              ],
            ),
          ],
  ...
  /// Common widget
  Widget _buildIcTickets({required String icTickets, required String matchCounter}) {
    return Container(
