...
class EventsDetailTwoModel {
 ...
 static List<GroundListModel> getGroundList(){
  return [
   // GroundListModel("", ImageConstant.imgRectangle3463281,"Main ground","3 Hour", 453, []),
   // GroundListModel("", ImageConstant.imgRectangle3463281107x110,"Futsal Ground","1 Hour", 343, []),
   // GroundListModel("", ImageConstant.imgRectangle34632811,"Tenis ground","2 Hour", 56, []),
  ];
 }
