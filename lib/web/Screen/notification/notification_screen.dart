                      ...
                      children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: Icon(Icons.arrow_back_ios_new_rounded, color: appTheme.themeColor),
                              ),
                              SizedBox(width: 30),
                              Text(
                                'notification'.tr,
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            padding: EdgeInsets.symmetric(horizontal: width*0.035,vertical: width*0.02).copyWith(bottom: width*0.013),
                            child: Column(
